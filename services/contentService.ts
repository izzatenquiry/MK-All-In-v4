...
const defaultTutorialContent: TutorialContent = {
  ...
  mainTitle: `Welcome to ${BRAND_CONFIG.name}`,
  mainDescription: `Welcome! This video is your introduction to the ${BRAND_CONFIG.domain} platform. Understand the big picture, the powerful features, and how to get started on your creative projects with the help of AI.`,
  tutorials: [
...
const getDefaultAnnouncements = (): Announcement[] => {
    ...
    return [
        {
            id: 'anno-1',
            title: 'Perlukan Akaun Google Ultra AI?',
            content: '45,000 kredit/sebulan. Boleh login terus di Gmail untuk full access semua produk Google seperti FLOW, GEMINI PRO, WHISK, dan lain-lain. Malah boleh dijadikan sebagai Personal Token — tanpa sharing, tanpa exhausted. Jika berminat, PM Admin. Akaun ULTRA AI yang kami sediakan adalah yang termurah di pasaran.',
            category: 'General',
            createdAt: new Date().toISOString(),
        },
    ];
...
export const getAnnouncements = async (): Promise<Announcement[]> => {
    ...
    // If no saved announcements, return brand-specific default
    return savedAnnouncements || getDefaultAnnouncements();
};
