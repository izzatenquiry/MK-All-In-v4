        ...
        <div className="w-full">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    {/* Special for MONOklix user Panel */}
                    {BRAND_CONFIG.name !== 'ESAIE' && (
                        <div className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-800">
                            <h3 className="text-base sm:text-lg font-bold mb-4 text-neutral-800 dark:text-neutral-200 flex items-center gap-2">
                                <SparklesIcon className="w-5 h-5 text-primary-500" />
                                Special for MONOklix user
                            </h3>
                            <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-4">Get your Google ULTRA AI Account with 45k credits for just RM49. Perfect for high-volume generation needs.</p>
                            ...
                            <div className="space-y-3">
                                <a
                                    ...
                                    className="w-full flex items-center justify-center gap-2 bg-green-600 dark:bg-green-700 text-white text-sm font-semibold py-2.5 px-4 rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors"
                                >
                                    <KeyIcon className="w-4 h-4" />
                                    Buy Google ULTRA AI Account 45k - RM49 Only
                                </a>
                            </div>
                        </div>
                    )}
